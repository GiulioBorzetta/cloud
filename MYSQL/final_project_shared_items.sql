...
CREATE TABLE `shared_items` (
  ...
  `sharedAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `qrCode` longtext,
  PRIMARY KEY (`id`),
  KEY `sharedWithUserId` (`sharedWithUserId`),
  KEY `ownerUserId` (`ownerUserId`),
  CONSTRAINT `shared_items_ibfk_1` FOREIGN KEY (`sharedWithUserId`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `shared_items_ibfk_2` FOREIGN KEY (`ownerUserId`) REFERENCES `users` (`id`) ON DELETE CASCADE
